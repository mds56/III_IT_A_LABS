...
public class MainActivity extends AppCompatActivity {
    ...
    String uname_;
    String pwd_;
    private String file = "\\home\\cse\\Desktop\\Filespro1.txt";
    String data;
    @Override
...
//data=ed1.getText().toString();
                try {
                    ...
                    Toast.makeText(getBaseContext(),"file saved" +
                            getFileStreamPath(file),Toast.LENGTH_SHORT).show();
                }
                catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    for(String record : file_read) {
                        ...
                        if(uname_pwd[0].equalsIgnoreCase(uname_) &&
                        uname_pwd[1].equals(pwd_)) {
                            isFound = true;
                        }
                    }
                    Toast.makeText(getBaseContext(),"" + isFound
